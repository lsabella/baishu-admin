...
import RendererWrapper0 from '/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/.umi/LocaleWrapper.jsx'
...
let routes = [
  ...
  LoadingComponent: require('/Users/user18/baishu_front/baishu-admin/baishu-admin/src/components/PageLoading/index').default,
}),
    "routes": [
      {
        "path": "/user",
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__User__models__register.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/User/models/register.js').then(m => { return { namespace: 'register',...m.default}})
],
...
models: () => [
  ...
  LoadingComponent: require('/Users/user18/baishu_front/baishu-admin/baishu-admin/src/components/PageLoading/index').default,
      ...
      {
        "component": () => React.createElement(require('/Users/user18/baishu_front/baishu-admin/baishu-admin/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true })
      }
    ]
  },
  {
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Dashboard__models__activities.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Dashboard/models/activities.js').then(m => { return { namespace: 'activities',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__chart.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Dashboard/models/chart.js').then(m => { return { namespace: 'chart',...m.default}}),
  import(/* webpackChunkName: 'p__Dashboard__models__monitor.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Dashboard/models/monitor.js').then(m => { return { namespace: 'monitor',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Forms__models__form.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Forms/models/form.js').then(m => { return { namespace: 'form',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__List__models__rule.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/List/models/rule.js').then(m => { return { namespace: 'rule',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Profile__models__profile.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Profile/models/profile.js').then(m => { return { namespace: 'profile',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Exception__models__error.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Exception/models/error.js').then(m => { return { namespace: 'error',...m.default}})
],
...
models: () => [
  ...
  app: window.g_app,
models: () => [
  import(/* webpackChunkName: 'p__Account__Settings__models__geographic.js' */'/Users/user18/baishu_front/baishu-admin/baishu-admin/src/pages/Account/Settings/models/geographic.js').then(m => { return { namespace: 'geographic',...m.default}})
],
